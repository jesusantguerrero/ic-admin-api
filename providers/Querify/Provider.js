...
class Provider extends ServiceProvider {
  ...
  register () {
    this.app.bind('Freesgen/Adonis/Querify', (model) => {
      ...
      return new (require('./models/traits/Querify'))(model)
    })
    this.app.alias('Freesgen/Adonis/Querify', 'Freesgen/Querify')
  }

  _bootServices () {
    this.app.bind('Freesgen/Adonis/BaseController', () => require('./controllers/BaseController'))
    this.app.alias('Freesgen/Adonis/BaseController', 'Freesgen/BaseController')

    this.app.bind('Freesgen/Adonis/BaseModel', () => require('./models/BaseModel'))
